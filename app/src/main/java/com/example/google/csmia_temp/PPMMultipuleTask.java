    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String Query = "SELECT ppm.*,\n" +
                    ...
                    " AND ppm.Task_Status = 'WO Generated' GROUP by ppm.Auto_Id";
                    ...
                    do {
                        ...
                        try {
                            ...
                            if (calenderCurrent.getTime().after(dateTimeStart) && calenderCurrent.getTime().before(dateTimeEnd)) {
                                taskProvider = new PpmTaskProvider(TaskId,Old_Task_Id,Site_Location_Id,activity_frequency,formatDate(dateTimeStart),Task_Status,asset_activity_linking_id,formatDate(dateTimeEnd),Activity_Name,Form_Id,Asset_Code,Asset_Name,Asset_Location,Asset_Type,Status,Assigned_To_User_Group_Id,Group_Name,updatedStatus);
        ...
        lv.addOnItemTouchListener(new RecyclerTouchListener(getApplicationContext(), lv, new RecyclerTouchListener.ClickListener() {
            ...
            public void onClick(View view, int position) {
                try {
                    ...
                    Asset_Location=taskProvider.getAsset_Location();
                    Old_Task_Id = taskProvider.getOldTaskId();
                    ...
                    intent.putExtra("OldTaskId",Old_Task_Id);
