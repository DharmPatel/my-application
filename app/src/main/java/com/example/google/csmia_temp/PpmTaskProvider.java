...
public class PpmTaskProvider {
    String TaskId,OldTaskId, Site_Location_Id,form_id,activity_frequency,updatedStatus,TaskScheduledDate,TaskEndTime,task_status,asset_activity_linking_id,timestartson,activity_duration,grace_duration_before,grace_duration_after,Activity_Name,Asset_Code,Asset_Name,Asset_Location,Asset_Type,Status,Assigned_To_User_Group_Id,Group_Name;
    ...
    public String setOldTaskId(String OldTaskId){
        return OldTaskId;
    }
