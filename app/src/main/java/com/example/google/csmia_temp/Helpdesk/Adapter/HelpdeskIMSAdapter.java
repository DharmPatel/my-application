...
public class HelpdeskIMSAdapter extends RecyclerView.Adapter<HelpdeskIMSAdapter.HelpdeskHolder> {
    Context context;
    ...
    public HelpdeskIMSAdapter(Context context, ArrayList<Ticket> ticketArrayList) {
