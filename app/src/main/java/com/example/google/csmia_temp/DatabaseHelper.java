...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        sqLiteDatabase.execSQL("CREATE TABLE Site_Details (Id INTEGER PRIMARY KEY ,Auto_Id TEXT,Site_Name_Label TEXT,Site_Name_Value TEXT,Assigned_To_User_Id TEXT,Site_DB_Name TEXT,Master_DB TEXT)");
        sqLiteDatabase.execSQL("CREATE TABLE Form_Structure (Id INTEGER PRIMARY KEY,Field_Id TEXT,Site_Location_Id TEXT,Form_Id TEXT,Field_Label TEXT,Field_Type TEXT,Field_Options TEXT,FixedValue Text,Mandatory INTEGER,sid INTEGER,sections TEXT,Display_Order INTEGER,SafeRange INTEGER,Calculation INTEGER,IMS_Id TEXT,Record_Status TEXT)");
        ...
        sqLiteDatabase.execSQL("CREATE TABLE Data_Posting(Id INTEGER PRIMARY KEY,Site_Location_Id TEXT,Task_Id TEXT,Form_Id TEXT,Form_Structure_Id TEXT,Parameter_Id TEXT,Value TEXT,IMSFlag TEXT,UOM Text,Remark TEXT,sid INTEGER,UpdatedStatus TEXT)");
        ...
        sqLiteDatabase.execSQL("CREATE TABLE Task_Details_Server (Id INTEGER PRIMARY KEY,Task_Id TEXT,Site_Location_Id TEXT,Activity_Frequency_Id TEXT,Asset_Id TEXT,Task_Scheduled_Date TEXT,Task_Status TEXT,Assigned_To_User_Id TEXT,Task_Start_At TEXT,Assigned_To_User_Group_Id TEXT,Remarks TEXT,UpdatedStatus TEXT)");
        ...
        sqLiteDatabase.execSQL("CREATE TABLE EmailList (Id INTEGER PRIMARY KEY, Email_Auto_Id TEXT,Site_Location_Id TEXT, Employee_Email TEXT,Email_For TEXT,Recipient_Type TEXT,Created_DateTime TEXT,Deleted_DateTime TEXT,Record_Status TEXT)");
        sqLiteDatabase.execSQL("CREATE TABLE Asset_Location (Id INTEGER PRIMARY KEY,Asset_Id TEXT,Building_Id TEXT,Floor_Id TEXT,Room_Id TEXT,building_code TEXT,building_name TEXT,floor_code TEXT,floor_name TEXT,room_area TEXT,Site_Location_Id TEXT)");
        sqLiteDatabase.execSQL("CREATE TABLE Ticket_Created (Id INTEGER PRIMARY KEY,Auto_Id TEXT,Site_Location_Id TEXT,Task_Id Text,Form_Ticket_Id TEXT,Created_User_Id TEXT,User_Group_Id TEXT,Ticket_Type TEXT,Ticket_Subject TEXT,Ticket_Content TEXT,Ticket_status TEXT,Status TEXT,Created_DateTime TEXT,Record_Status TEXT,UpdatedStatus Text)");
        sqLiteDatabase.execSQL("CREATE TABLE Ticket_Comments (Id INTEGER PRIMARY KEY,Auto_Id TEXT,Site_Location_Id TEXT,Ticket_Id Text,Created_User_Id TEXT,User_Group_Id TEXT,Comment TEXT,Created_DateTime TEXT,Record_Status TEXT,UpdatedStatus Text)");
        sqLiteDatabase.execSQL("CREATE TABLE Form_Ticket (Id INTEGER PRIMARY KEY,Auto_Id TEXT,Site_Location_Id TEXT,Form_section_Id TEXT,Product TEXT,Component TEXT,Department TEXT,Option_Selected TEXT,Ticket_For TEXT,Assigned_To TEXT,Ticket_Location_Id TEXT,IncidentSource TEXT,Loggedby TEXT,Created_Date_Time TEXT,Deleted_Date_Time TEXT,Record_Status TEXT)");
        sqLiteDatabase.execSQL("CREATE TABLE Site_Ticket_Location (Id INTEGER PRIMARY KEY,Auto_Id TEXT,Site_Location_Id TEXT,Site TEXT,Location TEXT,Sub_Location TEXT,Service_Area TEXT,Created_Date_Time TEXT,Deleted_Date_Time TEXT,Record_Status TEXT)");
        sqLiteDatabase.execSQL("CREATE TABLE SMS_Alert(Id INTEGER PRIMARY KEY ,Auto_Id TEXT,Mobile_Number TEXT,Site_Location_Id TEXT, User_Group_Id TEXT)");
    ...
    public int getTicketUser(String SiteId,String User_Id) {
        int formType = 0;
        String selectQuery = "SELECT * from Ticket_Created where Site_Location_Id ='" + SiteId + "' AND Created_User_Id ='"+User_Id+"' ";
        SQLiteDatabase database = this.getWritableDatabase();
        Cursor cursor = database.rawQuery(selectQuery, null);
        formType = cursor.getCount();
        cursor.close();
        database.close();
        return formType;
    }

    public String getAssetSite(String Asset_Id){
        String SiteQuery = "Select building_name from Asset_Location where Asset_Id = '"+Asset_Id+"'";
        SQLiteDatabase db = this.getReadableDatabase();
        String SiteName = "";
        Cursor cursorSite = db.rawQuery(SiteQuery,null);
        if(cursorSite.getCount()> 0){
            if(cursorSite.moveToFirst()) {
                do {
                    SiteName = cursorSite.getString(cursorSite.getColumnIndex("building_name"));
    ...
    public String getAssetLocationFloor(String Asset_Id){
        String SiteQuery = "Select floor_code from Asset_Location where Asset_Id = '"+Asset_Id+"'";
        SQLiteDatabase db = this.getReadableDatabase();
        String LocationName = "";
        Cursor cursorFloor = db.rawQuery(SiteQuery,null);
        if(cursorFloor.moveToFirst()) {
            do {
                LocationName = cursorFloor.getString(cursorFloor.getColumnIndex("floor_code"));
    ...
    public String getBuildName(String Site_Id){
        String buildNameQuery = "Select building_name from Asset_Location where Site_Location_Id = '"+Site_Id+"'";
        SQLiteDatabase db = this.getReadableDatabase();
        String Building_Name = "";
        Cursor cursorBuilding = db.rawQuery(buildNameQuery,null);
        if(cursorBuilding.getCount()>0){
            if(cursorBuilding.moveToFirst()){
                do{
                    Building_Name = cursorBuilding.getString(cursorBuilding.getColumnIndex("building_name"));
    ...
    public String getAssetSubLocation(String Asset_Id){
        String SiteQuery = "Select room_area from Asset_Location where Asset_Id = '"+Asset_Id+"'";
        SQLiteDatabase db = this.getReadableDatabase();
        String RoomName = "";
        Cursor cursorRoom = db.rawQuery(SiteQuery,null);
        if(cursorRoom.getCount()> 0){
            if(cursorRoom.moveToFirst()){
                do{
                    RoomName = cursorRoom.getString(cursorRoom.getColumnIndex("room_area"));
    ...
    public String Ticket_Asset_Name(String Task_Id){
        String AssetName="";
        try {
            String query = "select ad.Asset_Name from Asset_Details ad \n" +
                    " left join Task_Details td on\n" +
                    " td.asset_id = ad.asset_id\n" +
                    " left join Ticket_Created tc on\n" +
                    " tc.task_id = td.auto_id\n" +
                    " where tc.task_id = '"+Task_Id+"' Group by tc.task_id";
            SQLiteDatabase db = this.getWritableDatabase();
            Cursor res =db.rawQuery(query, null);
            if (res.moveToFirst()) {
                do {
                    AssetName=res.getString(0);
                } while (res.moveToNext());
            }
            res.close();
            //db.close();
    ...
    /*public String sectionActName(String Section_Id){
        String Act_Name="";
        try {
            String query = "select Activity_Name from Activity_Master where Form_Id = '"+Section_Id+"'";
            SQLiteDatabase db = this.getWritableDatabase();
            Cursor res =db.rawQuery(query, null);
            if (res.moveToFirst()) {
                do {
                    Act_Name=res.getString(res.getColumnIndex("Activity_Name"));
                    Log.d("Activity_Nameee","1: "+Act_Name);
                } while (res.moveToNext());
            }
            res.close();
            db.close();
    ...
    public String getTickStatus(String ticketId){
        String Site_Location_Id="";
        try {
            String query = "SELECT Ticket_status FROM Ticket_Created Where Auto_Id ='"+ticketId+"'";
            SQLiteDatabase db = this.getWritableDatabase();
            Cursor res =db.rawQuery(query, null);
            if (res.moveToFirst()) {
                do {
    ...
    public String gettype(String ticketId){
        String Site_Location_Id="";
        try {
            String query = "SELECT Ticket_Type FROM Ticket_Created Where Auto_Id ='"+ticketId+"'";
            SQLiteDatabase db = this.getWritableDatabase();
            Cursor res =db.rawQuery(query, null);
            if (res.moveToFirst()) {
                do {
    ...
    public String emailList_Cc(String SiteId){
        String emailquery = "Select Site_Location_Id, Employee_Email from EmailList where Site_Location_Id = '"+SiteId+"' AND Recipient_Type = 'Cc'";
        SQLiteDatabase database = this.getWritableDatabase();
    ...
    public String emailList_Bcc(String SiteId){
        String emailquery = "Select Site_Location_Id, Employee_Email from EmailList where Site_Location_Id = '"+SiteId+"' AND Recipient_Type = 'Bcc'";
        SQLiteDatabase database = this.getWritableDatabase();
    ...
    public String emailList_To(String SiteId){
        String emailquery = "Select Site_Location_Id, Employee_Email from EmailList where Site_Location_Id = '"+SiteId+"' AND Recipient_Type = 'To'";
        SQLiteDatabase database = this.getWritableDatabase();
        Cursor emailList = database.rawQuery(emailquery, null);
        StringBuilder sb =new StringBuilder();
        Log.d("Email_Query",emailquery+" "+emailList.getCount());
        if (emailList.getCount() > 0) {
            if(emailList.moveToFirst()){
                do{
                    sb.append(emailList.getString(emailList.getColumnIndex("Employee_Email"))).append(",");
                }while (emailList.moveToNext());
                Log.d("Email_Id_Value",sb.toString());
            }
        }
    ...
    public String UserGroupName(String UserGroupId){
        String Username="";
        try {
            String query = "SELECT Group_Name FROM User_Group Where User_Group_Id IN ("+UserGroupId+")";
            SQLiteDatabase db = getWritableDatabase();
            Cursor res =db.rawQuery(query, null);
            if (res.moveToFirst()) {
                do {
    ...
    public String UserName(String User_Id){
        String Username="";
        try {
            String query = "SELECT Username FROM Login_Details Where User_Id ='"+User_Id+"'";
            SQLiteDatabase db = getWritableDatabase();
            Cursor res =db.rawQuery(query, null);
            if (res.moveToFirst()) {
                do {
    ...
    public String lastFinalReading(String fieldId,String Asset_Id){
        ...
        if (cursor.getCount()!= 0) {
            ...
            String updateTaskServerQuery = "SELECT Task_Id from Task_Details_Server where Task_Status IN ('Completed','Unplanned','Delayed') AND Asset_Id = '"+Asset_Id+"' ORDER BY Task_Start_At DESC";
            Cursor curserTaskServer = database.rawQuery(updateTaskServerQuery,null);
            if(curserTaskServer.getCount()!=0){
                if(curserTaskServer.moveToFirst()){
                    do {
                        sb.append("'" + curserTaskServer.getString(0) + "',");
                    }while (curserTaskServer.moveToNext());
                }
            }
            curserTaskServer.close();
        }
        cursor.close();
    ...
    /*public String getSiteName(String User_Id){
        String Site_Name="";
        try {
            String query = "SELECT Site_Name FROM Settings Where User_Id ='"+User_Id+"'";
            SQLiteDatabase db = getWritableDatabase();
    ...
    public String getSmsUserName(){
        String Username = "";
        try{
            String UserQuery = "Select Username from SMS_Master";
            SQLiteDatabase db = this.getReadableDatabase();
    ...
    public String getSmsPassword(){
        String Password = "";
        try{
            String PasswordQuery = "Select Password from SMS_Master";
            SQLiteDatabase db = this.getReadableDatabase();
            Cursor c = db.rawQuery(PasswordQuery,null);
            if(c.moveToFirst()){
                do{
    ...
    public String getSmsType(){
        String Type = "";
        try{
            String TypeQuery = "Select Type from SMS_Master";
            SQLiteDatabase db = this.getReadableDatabase();
            Cursor c = db.rawQuery(TypeQuery,null);
            if(c.moveToFirst()){
                do{
                    Type = c.getString(0);
                } while (c.moveToNext());
    ...
    public String getSmsSource(){
        String Source = "";
        try{
            String SourceQuery = "Select Source from SMS_Master";
            SQLiteDatabase db = this.getReadableDatabase();
            Cursor c = db.rawQuery(SourceQuery,null);
            if(c.moveToFirst()){
                do{
    ...
    public String getSmsUrl(){
        String Url = "";
        try{
            String UrlQuery = "Select Url from SMS_Master";
            SQLiteDatabase db = this.getReadableDatabase();
    ...
    public String getassetStatus(String assetCode){
        ...
        if(cursor.getCount() !=0){
            ...
            if(cursorforCount.getCount() !=0) {
                if (cursorforCount.moveToFirst()) {
                    do {
                        assetStatus = cursorforCount.getString(0);
                        sb.append(assetStatus).append(",");
                    }while (cursorforCount.moveToNext());
                }
            } else{
        ...
        if(sb.toString().equalsIgnoreCase("Not Found")){
            return sb.toString();
        } else {
            return sb.deleteCharAt(sb.lastIndexOf(",")).toString();
        }
    ...
    public int getSid(String form_struct_id){
        int sid = -1;
        String selectQuery = "select sid from Form_Structure where Field_Id = '"+form_struct_id+"'";
        SQLiteDatabase database = this.getWritableDatabase();
    ...
    public boolean updatedTaskDetails(String Auto_Id,String Task_Status, String Conditional_Status,String Task_Start_At,String Scan_Type,String userId,String Remarks,int incident,String Type){
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
    ...
    public String getMobileNumber(String siteId){
        StringBuilder stringBuilder = new StringBuilder();
        String feedbackId="";
        try {
            String query = "SELECT Mobile_Number FROM SMS_Alert where Site_Location_Id ='"+siteId+"'";
    ...
    public boolean updatedPPMTaskDetails(String Auto_Id,String OldTaskId,String Task_Status, String Conditional_Status,String Task_Start_At,String Scan_Type,String userId,String Assigned_To_User_Group_Id,String Remarks){
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put("Old_PPM_Id",OldTaskId);
        contentValues.put("Task_Status", Task_Status);
...
*/
    ...
    public JSONArray composeJSONTicket(String UserId){
        JSONArray TicketJsonArray = new JSONArray();
        String[]loggerData = new LoggerFile().loggerFunction(UserId);

        String selectQuery = "SELECT  * FROM Ticket_Created WHERE UpdatedStatus = 'no' AND User_Group_Id IN ("+UserGroupId(UserId)+")";
        ...
        try {
            ...
            if (cursor.moveToFirst()) {
                int i=0;
                do {
                    //Log.d("Ticket"," "+cursor.getString(cursor.getColumnIndex("ID"))+"\n"+cursor.getString(cursor.getColumnIndex("Auto_Id"))+"\n");
                    JSONObject TicketJsonObject = new JSONObject();
                    TicketJsonObject.put("ID", cursor.getString(cursor.getColumnIndex("Id")));
                    TicketJsonObject.put("Auto_Id",  cursor.getString(cursor.getColumnIndex("Auto_Id")));
                    TicketJsonObject.put("Site_Location_Id",  cursor.getString(cursor.getColumnIndex("Site_Location_Id")));
                    TicketJsonObject.put("Task_Id",  cursor.getString(cursor.getColumnIndex("Task_Id")));
                    TicketJsonObject.put("Form_Ticket_Id",  cursor.getString(cursor.getColumnIndex("Form_Ticket_Id")));
                    TicketJsonObject.put("Created_User_Id",  cursor.getString(cursor.getColumnIndex("Created_User_Id")));
                    TicketJsonObject.put("User_Group_Id",  cursor.getString(cursor.getColumnIndex("User_Group_Id")));
                    TicketJsonObject.put("Ticket_Type",  cursor.getString(cursor.getColumnIndex("Ticket_Type")));
                    ...
                    TicketJsonObject.put("Ticket_status", cursor.getString(cursor.getColumnIndex("Ticket_status")));
                    TicketJsonObject.put("Created_DateTime", cursor.getString(cursor.getColumnIndex("Created_DateTime")));
                    TicketJsonObject.put("Record_Status", cursor.getString(cursor.getColumnIndex("Record_Status")));
                    TicketJsonArray.put(TicketJsonObject);

                    Log.d("TicketJson"," "+TicketJsonArray.getString(i));
                    i++;
                } while (cursor.moveToNext());
            }
        } catch (JSONException e) {
