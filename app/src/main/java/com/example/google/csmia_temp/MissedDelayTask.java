...
/**
 * Created by Megavision on 26-02-2018.
 */

public class MissedDelayTask extends AppCompatActivity {
    ...
    String listFromId,assetLocation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            String Query = "SELECT ug.Group_Name," +
                    ...
                    "AND td.Site_Location_Id='"+SiteId+"' AND asst.Task_State = 'A'  AND td.Task_Status ='Missed' AND Asset_Code='"+assetCode+"' AND td.RecordStatus != 'D'";
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    ...
                    assetLocation = taskDataAdapter.getItem(position).getAsset_Location();
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(MissedDelayTask.this, TaskDetails.class);
