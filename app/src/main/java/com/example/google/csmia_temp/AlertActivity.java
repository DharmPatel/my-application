            ...
            if (cursor1.getCount() == 0) {
                ...
                if (cursor1.moveToFirst()) {
                    do {
                        ...
                        String Query ="select a.Threshold_From ,a.Threshold_To,b.Value from Parameter a,Data_Posting b  where b.Form_Structure_Id = a.Form_Structure_Id and b.Task_Id='"+Task_Id+"' and a.Activity_Frequency_Id='"+FrequencyId+"' ";
