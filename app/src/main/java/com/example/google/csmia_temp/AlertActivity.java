...
public class AlertActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Deviations");
    ...
    public void showAlert(final String Task_Id,String Asset_Name,String FrequencyId) {
        ...
        try{
            ...
            Log.d("Tsesttrsx",cursor1.getCount()+" ");
            if (cursor1.getCount() == 0) {
                ...
                if (cursor1.moveToFirst()) {
                    do {
                        ...
                        String options = cursor1.getString(cursor1.getColumnIndex("Field_Options"));
                        String Field_Id = cursor1.getString(1);
                        int sid = cursor1.getInt(cursor1.getColumnIndex("sid"));
                        
                        String Query ="select a.Threshold_From ,a.Threshold_To,b.Value from Parameter a,Data_Posting b  where b.Form_Structure_Id = a.Form_Structure_Id and b.Task_Id='"+Task_Id+"' and a.Activity_Frequency_Id='"+FrequencyId+"' and a.Form_Structure_Id = '"+Field_Id+"'";
