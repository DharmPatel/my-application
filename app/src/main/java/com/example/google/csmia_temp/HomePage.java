...
public class HomePage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SyncStatusResult = getIntent().getStringExtra("SyncStatusResult");
        ...
        imageViewincidentReport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) { incidentReportActivity(); }
        });
    ...
    public void assetActivity() {
        try {
            if (myDb.SiteName(User_Id) == null) {
                ...
                Log.d("UserGroup",myDb.UserGroupName(myDb.UserGroupId(User_Id)));
    ...
    public void taskdetailsActivity() {
        try {
            if (myDb.SiteName(User_Id) == null) {
                ...
                String Query = "Select * from Activity_Frequency af left join Asset_Activity_Linking aal on aal.Auto_Id = af.Asset_Activity_Linking_Id left join Activity_Master am on am.Auto_Id = aal.Activity_Id where af.Site_Location_Id='" + myDb.Site_Location_Id(User_Id) + "' and am.Activity_Type = 'JobCard'";
                db = myDb.getWritableDatabase();
                Cursor cursor = db.rawQuery(Query, null);
                Log.d("TaskActivity",Query+" "+cursor.getCount());
                if (cursor.getCount() > 0) {
                    if (myDb.ScanType(User_Id).equals("QR")) {
    ...
    public void checklistActivity() {
        ...
        try {
            if (myDb.SiteName(User_Id) == null) {
                ...
                String Query = "Select * from Activity_Frequency af left join Asset_Activity_Linking aal on aal.Auto_Id = af.Asset_Activity_Linking_Id left join Activity_Master am on am.Auto_Id = aal.Activity_Id where af.Site_Location_Id='" + myDb.Site_Location_Id(User_Id) + "' and am.Activity_Type = 'CheckList'";
                db = myDb.getWritableDatabase();
                Cursor cursor = db.rawQuery(Query, null);
                if (cursor.getCount() > 0) {
                    if (myDb.ScanType(User_Id).equals("QR")) {
    ...
    public void ticketActivity() {
        ...
        try {
            if (myDb.SiteName(User_Id) == null) {
                ...
                startActivity(new Intent(HomePage.this, TicketTabActivity.class));
            }
        } catch (Exception e) {
            e.printStackTrace();
            Log.d("hp300", "ERROR==" + e);
    ...
    public void workpermitActivity(){
      /*  Snackbar snackbar = Snackbar.make(linearLayout, "License not activated.", Snackbar.LENGTH_LONG);
       ...
       /* Intent i = new Intent(this,WorkPermitActivity.class);
        startActivity(i);*/
    ...
    public void incidentReportActivity(){
        ...
        /*Intent intent= new Intent(HomePage.this,IncidentReport.class);
        startActivity(intent);*/
    }
    ...
    public void AutoSyncPref() {
        try {
            ...
            res.close();
            db.close();
            Log.d("MyServices","isInserted"+" Status:"+isInserted+" SyncStatus:: "+ myDb.AutoSyncSetting());
            /*if (isInserted == true) {
        ...
        try {
            ...
            if (res.moveToFirst()) {
                do {
                    ...
                    tvUsrname.setText(res.getString(0));
...
/*android:progressTint="#4d34ff"
            ...
            if (jsonStrTask != null) {
                try {
                    ...
                    try {
                        ...
                        if (Form_Ticket != null) {
                            db = myDb.getWritableDatabase();
                            String sql = "insert into Form_Ticket (Auto_Id ,Site_Location_Id ,Form_section_Id,Product ,Component ,Department ,Option_Selected,Ticket_For,Assigned_To,IncidentSource,Loggedby,Ticket_Location_Id,Created_Date_Time ,Deleted_Date_Time ,Record_Status) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?);";
                            db.beginTransaction();
                            SQLiteStatement stmt = db.compileStatement(sql);
                            for (int i = 0; i < Form_Ticket.length(); i++) {
                                ...
                                String Ticket_For = c.getString("Ticket_For");
                                ...
                                stmt.bindString(8, Ticket_For);
                                stmt.bindString(9, Assigned_To);
                                stmt.bindString(10, IncidentSource);
                                stmt.bindString(11, Loggedby);
                                stmt.bindString(12, Created_Date_Time);
                                stmt.bindString(13, Deleted_Date_Time);
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                if (sync == true) {
                    ...
                    if (myDb. AutoSyncSetting().equals("true")) {
                        Log.d("MyServices","DataDownloadComplete"+"IntentToMyService"+" SyncStatus: "+myDb.AutoSyncSetting());
                        startService(new Intent(getApplicationContext(), MyService.class));
                    }
                }
            } catch (Exception e) {
    ...
    public void deleteTask() {
        try {
            ...
            long resultset17 = db.delete("PPM_Task","Site_Location_Id='"+site_id+"'",null);
            db.close();
            if (resultset1 == -1 && resultset2 == -1 && resultset3 == -1 && resultset4 == -1 && resultset5 == -1 && resultset6 == -1 && resultset7 == -1 && resultset8 == -1 && resultset9 == -1 && resultset10 == -1 && resultset11 == -1 && resultset12==-1 && resultset13==-1 && resultset14==-1 && resultset15==-1 && resultset16==-1 && resultset17==-1 ) {
            } else {
...
/*
    ...
    public void exportDatabse(Context ctx) {
        ...
        try {
            ...
            Uri uri = FileProvider.getUriForFile(HomePage.this, BuildConfig.APPLICATION_ID + ".provider", new File("/storage/emulated/0/Facilitymate.zip"));
    ...
    protected void onNewIntent(Intent intent) {
        ...
        if(NFCbarcode!=null) {
            ...
            Toast.makeText(getApplicationContext(),"Please tap on JobCard",Toast.LENGTH_LONG).show();
        }
    }
